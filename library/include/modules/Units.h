...
/// The HF version of the fn won't give custom profession or "Agitated" prefix.
/// HF professions don't necessarily match unit professions. (Your legendary weaponsmith might be a monk.)
DFHACK_EXPORT std::string getProfessionName(df::historical_figure *hf, bool ignore_noble = false, bool plural = false, bool land_title = false);
