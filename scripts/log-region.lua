...
if args[1] == 'disable' then
    ...
    dfhack.onStateChange[_ENV] = function(op)
        if op == SC_WORLD_LOADED then -- there's a problem here - it's fine with fort mode, but loading legends or adventurer returns a nil error as 'site' is a nil value
