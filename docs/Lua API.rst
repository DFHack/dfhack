...
The first call for a tag-getting function caches the result, subsequent calls ignore the tag type arguments and return from the cache. More advanced raw constructs are planned.
