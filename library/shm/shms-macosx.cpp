...
int SDL_Init_orig(uint32_t flags);
void SDL_Quit_orig(void);
...
DFhackCExport int SDL_Init(uint32_t flags)
{
    ...
    _SDL_Init = (int (*)( uint32_t )) SDL_Init_orig; //dlsym(RTLD_SELF, "SDL_Init_orig");
    //_SDL_Flip = (int (*)( void * )) dlsym(RTLD_NEXT, "SDL_Flip");
    _SDL_Quit = (void (*)( void )) SDL_Quit_orig;  //dlsym(RTLD_SELF, "SDL_Quit_orig");
