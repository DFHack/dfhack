...
function test.setTickRate()
    ...
    expect.eq(dt.ticks_per_month, DWARF_TICKS_PER_DAY * dateT.DAYS_PER_MONTH)
...
function test.getDayOfMonth()
    local dt = dateT.DateTime {year_tick = DWARF_TICKS_PER_DAY * dateT.DAYS_PER_MONTH + 1, ticks_per_day = DWARF_TICKS_PER_DAY}
...
function test.monthsToTicks()
    ...
    expect.eq(t, DWARF_TICKS_PER_DAY * dateT.DAYS_PER_MONTH)
end
...
function test.calendar_ops()
    local dt_a = dateT.DwarfCalendar {year = 1, year_tick = DWARF_TICKS_PER_DAY, ticks_per_day = DWARF_TICKS_PER_DAY}
    local dt_b = dateT.DwarfCalendar {year = 1, year_tick = DWARF_TICKS_PER_DAY + 1, ticks_per_day = DWARF_TICKS_PER_DAY}
    local dt = dt_b - dt_a
    expect.eq(dt.year, 0)
    expect.eq(dt.year_tick, 1)
...
function test.dateTime_ops()
    local dt_a = dateT.DateTime {year = 1, year_tick = DWARF_TICKS_PER_DAY, ticks_per_day = DWARF_TICKS_PER_DAY}
    local dt_b = dateT.DateTime {year = 1, year_tick = DWARF_TICKS_PER_DAY + 1, ticks_per_day = DWARF_TICKS_PER_DAY}
    local dt = dt_b - dt_a
    expect.eq(dt.year, 0)
    expect.eq(dt.year_tick, 1)
...
function test.dateTime_getTime()
    ...
    local dt = dateT.DateTime {year_tick = 7325, ticks_per_day = dateT.ADVENTURE_TICKS_PER_DAY}
...
function test.duration_getDays()
    local d = dateT.Duration {year = 1, year_tick = DWARF_TICKS_PER_DAY + 1, ticks_per_day = DWARF_TICKS_PER_DAY}
...
function test.duration_getYearsMonthsDays()
    local d = dateT.Duration {year = 1, year_tick = (DWARF_TICKS_PER_DAY * dateT.DAYS_PER_MONTH) + DWARF_TICKS_PER_DAY + 1,
...
function test.duration_ops()
    local dt_a = dateT.Duration {year = 1, year_tick = DWARF_TICKS_PER_DAY, ticks_per_day = DWARF_TICKS_PER_DAY}
    local dt_b = dateT.Duration {year = 1, year_tick = DWARF_TICKS_PER_DAY + 1, ticks_per_day = DWARF_TICKS_PER_DAY}
    local dt = dt_b - dt_a
    expect.eq(dt.year, 0)
    expect.eq(dt.year_tick, 1)
