...
local SLIDER_LEFT_END = to_pen{ch=222, fg=COLOR_GREY, bg=COLOR_BLACK}
local SLIDER_RIGHT_END = to_pen{ch=221, fg=COLOR_GREY, bg=COLOR_BLACK}
...
function RangeSlider:onRenderBody(dc, rect)
    ...
    dc:char(nil, SLIDER_TAB_RANGE_RIGHT)
    dc:seek(width_per_idx*(right_idx-1)+4)
    dc:char(nil, SLIDER_TAB_RANGE_LEFT)
    dc:char(nil, SLIDER_TAB_CENTER)
