 ...
 */
inline df::creature_raw* find_creature ( int32_t idx )
{
 ...
 */
inline int16_t find_creature ( const std::string &creature_id )
{
...
*/
inline df::plant_raw* find_plant ( size_t idx )
{
 ...
 * @return -1 if not found
 */
inline size_t find_plant ( const std::string &plant_id )
{
 ...
 */
inline bool is_dfstockfile ( const std::string& filename )
{
