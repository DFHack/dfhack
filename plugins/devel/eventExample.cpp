...
*/
    ...
    EventManager::EventHandler initiateHandler(plugin_self, jobInitiated, 1);
    ...
    EventManager::EventHandler buildingHandler(plugin_self, building, 500);
    EventManager::EventHandler constructionHandler(plugin_self, construction, 100);
    EventManager::EventHandler syndromeHandler(plugin_self, syndrome, 1);
    EventManager::EventHandler invasionHandler(plugin_self, invasion, 1000);
    EventManager::EventHandler unitAttackHandler(plugin_self, unitAttack, 1);
    EventManager::unregisterAll(plugin_self);

    EventManager::registerListener(EventManager::EventType::JOB_INITIATED, initiateHandler);
    ...
    EventManager::registerListener(EventManager::EventType::BUILDING, buildingHandler);
    EventManager::registerListener(EventManager::EventType::CONSTRUCTION, constructionHandler);
