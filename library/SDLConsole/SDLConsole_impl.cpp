...
const char* (*SDL_GetError)() = nullptr;

static void bind_sdl_symbol(const char* name, void** addr)
{
...
static void bind_sdl_symbols()
{
    ...
    bind_sdl_symbol("SDL_GetError", (void**)&SDLConsoleLib::SDL_GetError);
}
...
public:
    explicit TrueTypeFont(SDL_Renderer* renderer)
        : FontRenderer(renderer)
    {
    }
    ...
    {
        auto font = std::make_unique<TrueTypeFont>(renderer);
