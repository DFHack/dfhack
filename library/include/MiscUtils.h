...
// MAP macro for implementing preprocessor foreach
// from https://github.com/swansontec/map-macro/blob/master/map.h
// MAP_JOIN was added as a generalization of the existing MAP_LIST
/*
...
#define MAP_JOIN_NEXT1(sep, test, next) MAP_NEXT0(test, sep next, 0)
#define MAP_JOIN_NEXT(sep, test, next)  MAP_JOIN_NEXT1(sep, MAP_GET_END test, next)

#define MAP_JOIN0(f, sep, x, peek, ...) f(x) MAP_JOIN_NEXT(sep, peek, MAP_JOIN1)(f, sep, peek, __VA_ARGS__)
#define MAP_JOIN1(f, sep, x, peek, ...) f(x) MAP_JOIN_NEXT(sep, peek, MAP_JOIN0)(f, sep, peek, __VA_ARGS__)
 ...
 * inserts the given separator between the results.
 */
#define MAP_JOIN(f, sep, ...) EVAL(MAP_JOIN1(f, sep, __VA_ARGS__, ()()(), ()()(), ()()(), 0))

/**
 * Applies the function macro `f` to each of the remaining parameters and
 * inserts commas between the results.
 */
#define MAP_LIST(f, ...) MAP_JOIN(f, MAP_COMMA, __VA_ARGS__)
