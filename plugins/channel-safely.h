...
protected:
    void foreach_block(bool full_scan);
...
protected:
    void build_groups(bool full_scan = false) { groups.read(full_scan); }
public:
    void manage_designations(color_ostream &out, bool full_scan);
