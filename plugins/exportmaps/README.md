...
Only enhanced biome map is not generated, as I consider it confusing and useless. Also a new region map was added.
...
#### New map types
As the plugin get the data natively from DF, new maps can be generated, like geology ones.
